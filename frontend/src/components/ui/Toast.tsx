...
> = {
  success: {
    ...
    container:
      "border-success-light/30 bg-success-light/10 dark:border-success-dark/30 dark:bg-success-dark/10",
    iconColor: "text-success-light dark:text-success-dark",
  },
  error: {
    icon: <AlertCircle className="h-5 w-5" strokeWidth={1.5} aria-hidden />,
    container:
      "border-error-light/30 bg-error-light/10 dark:border-error-dark/30 dark:bg-error-dark/10",
    iconColor: "text-error-light dark:text-error-dark",
  },
  info: {
    icon: <Info className="h-5 w-5" strokeWidth={1.5} aria-hidden />,
    container:
      "border-info-light/30 bg-info-light/10 dark:border-info-dark/30 dark:bg-info-dark/10",
...
export function Toast({
  ...
  return (
    <div
      ...
      aria-live="polite"
      className={cn(
        "flex w-full max-w-md items-start gap-3 rounded-xl border p-4 shadow-glass",
        config.container,
        className,
      )}
    >
