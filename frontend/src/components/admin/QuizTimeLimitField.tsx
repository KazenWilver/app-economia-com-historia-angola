...
export function QuizTimeLimitField({ values, onChange }: QuizTimeLimitFieldProps) {
  ...
  return (
    <fieldset className="space-y-3 md:col-span-2">
      ...
      {values.time_limit_enabled ? (
        <div className="space-y-4 rounded-xl border border-slate-200 bg-white p-4 dark:border-border-dark dark:bg-surface-dark-card">
          <div className="grid gap-4 sm:grid-cols-[minmax(0,1fr)_auto] sm:items-end">
            ...
            <fieldset className="space-y-2">
              ...
              <div className="inline-flex rounded-lg border border-slate-200 p-1 dark:border-border-dark">
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        ...
                        isSelected
                          ? "bg-bordeaux text-white dark:bg-bordeaux-dark"
                          : "text-slate-600 hover:bg-slate-100 dark:text-content-dark-secondary dark:hover:bg-surface-dark-secondary",
                      )}
                    >
                      {option.label}
                    </button>
                ...
                <button
                  ...
                  className={cn(
                    ...
                    values.time_limit_unit === "minutes" &&
                      ...
                      : "border-slate-200 bg-slate-50 text-slate-700 hover:border-slate-300 dark:border-border-dark dark:bg-surface-dark-secondary dark:text-content-dark-secondary",
                  )}
                >
                  {minutes} min
                </button>
